...
class RegressionModel(object):
    ...
    def run(self, x):
        ...
        activated1 = nn.ReLU(xw1_plus_b1)
        
        xw2 = nn.Linear(activated1, self.w2)
        xw2_plus_b2 = nn.AddBias(xw2, self.b2)
        activated2 = nn.ReLU(xw2_plus_b2)
        
        xw3 = nn.Linear(activated2, self.w3)
        predicted_y = nn.AddBias(xw3, self.b3)
...
class DigitClassificationModel(object):
    ...
    def run(self, x):
        ...
        predicted_y = nn.AddBias(nn.Linear(activated2, self.w3), self.b3)
        return predicted_y
