...
This Project has a custom autograder.
Originally cloned from Berkely CS 188 Projects, my version 
supports Gradescope output.
UVU Author: George Rudolph
Date: 9 Dec 2021
'''
import optparse
import pickle
...
def parse_options(argv):
    ...
    parser.add_option('--gradescope-output',
                        dest = 'gs_output',
                        action = 'store_true',
                        help = 'Produce Gradescope-formatted json results file.')
...
def main():
    ...
    if options.gs_output:
        tracker.produceGradeScopeOutput()
